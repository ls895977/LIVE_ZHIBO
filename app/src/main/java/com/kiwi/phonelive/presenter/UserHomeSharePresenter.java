...
public class UserHomeSharePresenter {
    ...
    public void copyLink() {
        ...
        String link = HtmlConfig.SHARE_HOME_PAGE + mToUid+"&uid="+ AppConfig.getInstance().getUid();
    ...
    public void shareHomePage(String type) {
        ...
        String webUrl = HtmlConfig.SHARE_HOME_PAGE + mToUid+"&uid="+ AppConfig.getInstance().getUid();;
