...
public class RefreshLayout extends FrameLayout {
    ...
    public RefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDown4 = resources.getString(R.string.refresh_down_4);
    ...
    private void addHeadAndFoot() {
        ...
        text_time = (TextView) mHeadView.findViewById(R.id.text_time);
    ...
    private void scrollToRefreshHeight() {
        ...
        if (mDownStatus != DOWN_3) {
            String des = String.format(WordUtil.getString(R.string.refresh_down_4), time1);
            mDownStatus = DOWN_3;
            mHeadTextView.setText(mDown3);
            text_time.setText(des);
        }
