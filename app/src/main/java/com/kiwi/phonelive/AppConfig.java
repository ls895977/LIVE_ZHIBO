...
public class AppConfig {
    ...
    public static final String HOST = "http://live711.net";
    //外部sd卡
    ...
    public void getConfig(Context context,CommonCallback<ConfigBean> callback) {
        if (callback == null) {
            return;
        }
        ConfigBean configBean = getConfig();
        if (configBean != null) {
            ...
            HttpUtil.getConfig(context,callback);
        }
    }
