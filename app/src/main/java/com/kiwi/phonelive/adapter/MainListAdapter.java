        ...
        void setData(Object payload) {
            ...
            if (topSize > 0) {
                ...
                if (bean.getAttention() == 1) {
                    ...
                    mBtnFollow1.setTextColor(mContext.getResources().getColor(R.color.gray1));
                    mBtnFollow1.setBackground(mContext.getResources().getDrawable(R.drawable.bg_btn_follow_gray));
                } else {
                    mBtnFollow1.doChecked(false);
                    mBtnFollow1.setText(mFollow);
                    mBtnFollow1.setTextColor(mContext.getResources().getColor(R.color.global));
                    mBtnFollow1.setBackground(mContext.getResources().getDrawable(R.drawable.bg_btn_follow));
                }
            }
            if (topSize > 1) {
                ...
                if (bean.getAttention() == 1) {
                    ...
                    mBtnFollow2.setTextColor(mContext.getResources().getColor(R.color.gray1));
                    mBtnFollow2.setBackground(mContext.getResources().getDrawable(R.drawable.bg_btn_follow_gray));
                } else {
                    mBtnFollow2.doChecked(false);
                    mBtnFollow2.setText(mFollow);
                    mBtnFollow2.setTextColor(mContext.getResources().getColor(R.color.global));
                    mBtnFollow2.setBackground(mContext.getResources().getDrawable(R.drawable.bg_btn_follow));
                }
            ...
            if (topSize > 2) {
                ...
                if (bean.getAttention() == 1) {
                    ...
                    mBtnFollow3.setTextColor(mContext.getResources().getColor(R.color.gray1));
                    mBtnFollow3.setBackground(mContext.getResources().getDrawable(R.drawable.bg_btn_follow_gray));
                } else {
                    mBtnFollow3.doChecked(false);
                    mBtnFollow3.setText(mFollow);
                    mBtnFollow3.setTextColor(mContext.getResources().getColor(R.color.global));
                    mBtnFollow3.setBackground(mContext.getResources().getDrawable(R.drawable.bg_btn_follow));
                }
