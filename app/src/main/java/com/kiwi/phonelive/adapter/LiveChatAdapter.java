...
public class LiveChatAdapter extends RecyclerView.Adapter {
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(LiveChatBean bean) {
            ...
            Log.e("zlg", "type==========" + bean.getType());
            if (bean.getType() == LiveChatBean.SYSTEM) {
                mTextView.setTextColor(0xffff0088);
                mTextView.setText(bean.getContent());
                Log.e("zlg", "系统消息=======" + bean.getContent());
            } else {
                if (bean.getType() == LiveChatBean.ENTER_ROOM || bean.getType() == LiveChatBean.LIGHT || bean.getType() == LiveChatBean.NORMAL) {
    ...
    public void insertItem(LiveChatBean bean) {
        ...
        for (int i = 0; i < size; i++) {
            Log.e("zlg", "聊天内容=======" + mList.get(i).getContent());
        }
