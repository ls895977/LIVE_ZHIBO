...
import com.kiwi.phonelive.views.CenterTextView;
...
public class DialogUitl {
    ...
    public static Dialog loadingDialog(Context context, String text) {
        ...
        if (!TextUtils.isEmpty(text)) {
            CenterTextView titleView = (CenterTextView) dialog.findViewById(R.id.text);
            if (titleView != null) {
            ...
            View.OnClickListener listener = new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (v.getId() == R.id.btn_confirm) {
                        ...
                        dialog.dismiss();
                        mClickCallback.onCancelClick(dialog);
