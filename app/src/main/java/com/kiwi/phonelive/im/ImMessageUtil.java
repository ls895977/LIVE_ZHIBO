...
public class ImMessageUtil {
    ...
    public void onEvent(ContactNotifyEvent event) {
        if (event.getType() == ContactNotifyEvent.Type.invite_received) {
            ...
            Log.e("zlg", "收到好友邀请" + fromUsername);
            /*RequestEvent requestEvent = new RequestEvent();
            requestEvent.setTouid(fromUsername);*/
    ...
    public List<ImUserBean> getLastMsgInfoList(List<ImUserBean> list) {
        ...
        for (ImUserBean bean : list) {
            ...
            if (conversation != null) {
                ...
                if (msg != null) {
                    bean.setLastTime(TimeUtil.getTimeFormatText(new Date(msg.getCreateTime())));
...
//    }
    ...
    public void defaultMediaPlayer() throws Exception {
        ...
        Ringtone r = RingtoneManager.getRingtone(AppContext.sInstance, notification);
        r.play();
    }
    ...
    public void onEvent(MessageEvent event) throws Exception {
        ...
        if (canShow) {
            ...
            imUserMsgEvent.setLastTime(TimeUtil.getTimeFormatText(new Date(msg.getCreateTime())));
     ...
     * 接收离线消息
     */
    public void onEvent(OfflineMessageEvent event) throws Exception {
    ...
    public void sendMessage(Message msg) {
        ...
        msg.setOnSendCompleteCallback(new BasicCallback() {
            ...
            public void gotResult(int responseCode, String responseDesc) {
                if (responseCode == 0) {
                    //消息发送成功
                    EventBus.getDefault().post(new SendCompleteEvent());
                } else {
                    //消息发送失败
                }
            }
