...
//    private TextView mDayView;
    ...
    private RelativeLayout result_gif;
...
//        mDayView = (TextView) findViewById(R.id.day);
        ...
        result_gif = (RelativeLayout) findViewById(R.id.result_gif);
...
//        findViewById(R.id.btn_close).setOnClickListener(this);
    ...
    public void setData(List<BonusBean> list, int day, String continueDay) {
        mList = list;
        mDay = day;
        String s = WordUtil.getString(R.string.bonus_sign_1) + "<font color='#FF0088'>" + continueDay + "</font>" + WordUtil.getString(R.string.bonus_day);
//        mDayView.setText(Html.fromHtml(s));
    ...
    private void playSuccessAnim() {
        ...
        result_gif.setVisibility(View.VISIBLE);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                result_gif.setVisibility(View.GONE);
                dismiss();
            }
        },3000);
       /*
