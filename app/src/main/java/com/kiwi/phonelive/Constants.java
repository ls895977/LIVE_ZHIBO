...
public class Constants {
    ...
    public static final String VOTES = "dp";
    ...
    public static final int MANUAL_RECHARGE = 8003;
    public static final int SELF_SERVICE_RECHARGE = 8004;
    ...
    public static final String CASH_USER_NAME = "cashUserName";
    public static final String CASH_BANK_NAME = "cashBankName";
    ...
    public static int VIDEO_Status = 1;//1：主activity进入返回首页视频发布，2：动态发布
    public static String VIDEO_Path = "";
    public static int VIDEO_PmSaveType = 1;
