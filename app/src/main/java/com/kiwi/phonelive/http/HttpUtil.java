...
import com.kiwi.phonelive.utils.Emoji;
...
public class HttpUtil {
    ...
    //2af2ba29e4416
    //b7d3ab167be0c2077c0601eb6ac57244
    ...
    public static void getConfig(Context context,final CommonCallback<ConfigBean> commonCallback) {
        HttpClient.getInstance().get("Home.getConfig", HttpConsts.GET_CONFIG)
                .params("uid", TextUtils.isEmpty(AppConfig.getInstance().getUid())?"":AppConfig.getInstance().getUid())
                .params("l", LocalManageUtil.getSelectLanguage(context).equals(context.getResources().getString(R.string.language_en))?"en-US":"zh-Hans-US")
     ...
     * 手机号 密码登录
     */
    public static void login(String phoneNum, String pwd, Context context, HttpCallback callback) {
     ...
     * 获取验证码接口 注册用
     */
    public static void getRegisterCode(String mobile, Context context,HttpCallback callback) {
     ...
     * 手机注册接口
     */
    public static void register(String user_login, String pass, String pass2, String code, Context context,HttpCallback callback) {
     ...
     * 找回密码
     */
    public static void findPwd(String user_login, String pass, String pass2, String code,Context context, HttpCallback callback) {
     ...
     * 获取验证码接口 找回密码用
     */
    public static void getFindPwdCode(String mobile,Context context, HttpCallback callback) {
        String sign = MD5Util.getMD5("mobile=" + mobile + "&" + SALT);
     ...
     */
    public static void checkLive(String liveUid, String stream,Context context, HttpCallback callback) {
     ...
     * 开心牛仔庄家流水
     */
    public static void gameNiuBankerWater(String bankerId, String stream,Context context, HttpCallback callback) {
     ...
     * 获取举报内容列表
     */
    public static void getCusServiceUser(HttpCallback callback) {
        HttpClient.getInstance().post("User.getCusServiceUser", HttpConsts.GET_CUSSERVICE_USER)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 语言切换
     */
    public static void setLanguage(String l, HttpCallback callback) {
        HttpClient.getInstance().post("User.switchLanguage", HttpConsts.SWITCH_LANGUAGE)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("l", l)
                .execute(callback);
     ...
     * 添加好友
     * */
    public static void addFriend(String touid, String msg, HttpCallback callback) {
        HttpClient.getInstance().post("User.friendRequest", HttpConsts.FRIENDREQUEST)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("touid", touid)
                .params("msg", msg)
     ...
     * 好友请求数
     * */
    public static void friedNum(HttpCallback callback) {
        HttpClient.getInstance().post("User.friendRequestNum", HttpConsts.FRIENDREQUESTNUM)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 好友请求列表
     * */
    public static void friendRequestList(HttpCallback callback) {
        HttpClient.getInstance().post("User.friendRequestList", HttpConsts.FRIENDREQUESTLIST)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 好友验证
     * */
    public static void friendVerify(String touid, String status, HttpCallback callback) {
        HttpClient.getInstance().post("User.friendVerify", HttpConsts.FRIENDVERIFY)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("touid", touid)
                .params("status", status)
                .execute(callback);
        Log.e("zlg", "token===" + AppConfig.getInstance().getToken());
    }

    /*
     * 好友数量
     * */
    public static void getFriendNum(HttpCallback callback) {
        HttpClient.getInstance().post("User.getFriendNum", HttpConsts.GETFRIENDNUM)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 好友列表
     * */
    public static void getFriendList(HttpCallback callback) {
        HttpClient.getInstance().post("User.getFriendList", HttpConsts.GETFRIENDLIST)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 删除好友
     * */
    public static void friendDel(String touid, HttpCallback callback) {
        HttpClient.getInstance().post("User.friendDel", HttpConsts.FRIENDDEL)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("touid", touid)
                .execute(callback);
     ...
     * 上传凭证
     * */
    public static void uploadRecord(String leave_message, File file_img,String money_num,String diamond_num, HttpCallback callback) {
        HttpClient.getInstance().post("Message.voucher", HttpConsts.MESSAGE_VOUCHER)
                .isMultipart(true)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("leave_message", leave_message)
                .params("file_img", file_img)
                .params("money_num", money_num)
                .params("diamond_num", diamond_num)
                .execute(callback);
    }
     ...
     * 上传凭证列表
     * */
    public static void uploadRecordProgress(HttpCallback callback){
        HttpClient.getInstance().get("Message.voucher_process", HttpConsts.MSSAGE_VOUCHER_PROGRESS)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 钻石充值记录
     * */
    public static void coinRechargeRecord(HttpCallback callback){
        HttpClient.getInstance().get("Message.voucher_detailed", HttpConsts.MSSAGE_VOUCHER_DETAIL)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    * 开屏广告
    * */
    public static void getAdvert(final Context context,String position, final int flag,final MyHttpCallBack callBack) {
        OkHttpUtils.get()
                .url("http://advert.banana6666.com/api/advert?")
                .addParams("name", "711")
                .addParams("timestamp", "1563858958")
                .addParams("sign", MD5Util.getMD5("timestamp=1563858958&name=711&random=711live"))
                        ...
                        if (context != null) {
                            if (callBack != null) {
                                try {
                                    ...
                                    } else if (jsonObject.getInt("code") == 401 && jsonObject.getString("msg").equals("Login expired")) {
...
//                                        context.startActivity(intent);
    ...
    * 统计点击广告
    * */
    public static void getAdvertClick(final Context context,String position,int id, final int flag,final MyHttpCallBack callBack) {
        OkHttpUtils.get()
                .url("http://advert.banana6666.com/api/advert/app_store?")
                .addParams("name", "711")
                .addParams("timestamp", "1563858958")
                .addParams("sign", MD5Util.getMD5("timestamp=1563858958&name=711&random=711live"))
                .addParams("position",position)
                .addParams("id",id+"")
                .addParams("phone_type","2")
                .addParams("type","2")
                .build()
                .execute(new com.zhy.http.okhttp.callback.StringCallback() {
                    @Override
