...
public class HttpConsts {
    ...
    public static final String GET_CUSSERVICE_USER = "getCusServiceUser";
    public static final String SWITCH_LANGUAGE = "switchLanguage";
    public static final String FRIENDREQUEST = "friendRequest";
    public static final String FRIENDREQUESTNUM = "friendRequestNum";
    public static final String FRIENDREQUESTLIST = "friendRequestList";
    public static final String GETFRIENDNUM = "getFriendNum";
    public static final String GETFRIENDLIST = "getFriendList";
    public static final String FRIENDDEL = "friendDel";
    public static final String MESSAGE_VOUCHER = "Messagevoucher";
    public static final String MSSAGE_VOUCHER_PROGRESS = "Messagevoucherprocess";
    public static final String MSSAGE_VOUCHER_DETAIL = "Messagevoucherdetail";
    public static final String ADVERTISING = "ADVERTISING";
    public static final String FRIENDVERIFY = "friendVerify";
